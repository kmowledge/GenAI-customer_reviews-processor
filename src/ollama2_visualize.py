...
def load_processed_data(processed_file):
    ...
    return pd.read_csv(processed_file, encoding=encoding, on_bad_lines="skip")
...
def visualize_sentiment_metrics(data):
    ...
    plt.savefig("../data/confusion_matrix_o2.png")
    plt.close()
    ...
    plt.savefig("../data/metrics_chart_o2.png")
    plt.close()
...
def visualize_satisfaction_scores(data):
    ...
    plt.savefig("../data/satisfaction_by_sentiment_o2.png")
    plt.close()
...
def visualize_locations(locations_data):
    ...
    plt.tight_layout()
    plt.savefig("../data/top_locations_o2.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("../data/entity_types_o2.png")
    plt.close()


if __name__ == "__main__":
    # File paths
    processed_file = "../data/generated/processed_reviews_o2.csv"
    locations_file = "../data/generated/extracted_locations_o2.csv"
