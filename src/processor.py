...
def process_customer_reviews(input_file, output_file, locations_file):
    ...
    for review_data in data:
        ...
        ground_truth_sentiment = True if review_data["survey_sentiment"] == "positive" else False
        ...
        result["sentiment"] = "positive" if sentiment_result["positive_sentiment"] else "negative"
...
def save_results_to_csv(results, output_file):
    with open(output_file, 'w', newline='') as f:
        ...
        if results and len(results) > 0:
            ...
            headers = ["review", "sentiment", "reasoning", "ground_truth", "satisfaction_score"]
