...
def visualize_sentiment_metrics(data):
    ...
    plt.savefig("../data/confusion_matrix_o.png")
    plt.close()
    ...
    plt.savefig("../data/metrics_chart_o.png")
    plt.close()
...
def visualize_satisfaction_scores(data):
    ...
    plt.savefig("../data/satisfaction_by_sentiment_o.png")
    plt.close()
...
def visualize_locations(locations_data):
    ...
    plt.tight_layout()
    plt.savefig("../data/top_locations_o.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("../data/entity_types_o.png")
    plt.close()


if __name__ == "__main__":
    # File paths
    processed_file = "../data/generated/processed_reviews_o.csv"
